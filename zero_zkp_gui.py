...
class AppGUI(tk.Tk):
    def __init__(self):
        ...
        self.title(f"Zero {self.app_name} - Arch Linux Native GUI")
    ...
    def start_engine(self):
        self.log(f"[Arch] Booting {self.app_name} Graphical Engine...")
    ...
    def engine_loop(self):
        ...
        self.log(f"\n[Arch] {self.app_name} Engine sequence completed successfully.")
